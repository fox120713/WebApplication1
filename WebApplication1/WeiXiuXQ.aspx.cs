...
{
    public partial class WeiXiuXQ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.Label5.Text = dt.Rows[0][8].ToString();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string test = dt.Rows[0][9].ToString();
            string test1 = dt.Rows[0][10].ToString();
            if (test == "" || test == null)
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string id = Request["id"];
            prepnbll.Prpen_date_start(date, id);
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)//判断是否有文件
            {
                ...
                if (kzm == ".jpg" || kzm == ".png" || kzm == ".jpeg")
                {
                    ...
                    string id = Request["id"];
                    string date = DateTime.Now.ToString();
                    prepnbll.Prpen_date_end(date, filename, id);
