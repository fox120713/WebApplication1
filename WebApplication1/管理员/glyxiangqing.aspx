<%@ Page Title="" Language="C#" MasterPageFile="~/管理员/site.Master" AutoEventWireup="true" CodeBehind="glyxiangqing.aspx.cs" Inherits="WebApplication1.管理员.glyxiangqing" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="bac">
        ...
        <div class="wenb">
            ...
            <div class="out" style="margin-left:20px">
                <table width="100%">
                    <tr>
