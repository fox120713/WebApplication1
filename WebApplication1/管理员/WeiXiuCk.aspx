<%@ Page Title="" Language="C#" MasterPageFile="~/管理员/site.Master" AutoEventWireup="true" CodeBehind="WeiXiuCk.aspx.cs" Inherits="WebApplication1.管理员.WeiXiuCk" %>
     ...
     <div class="panel panel-default">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="审核" ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName='<%# Eval("ReID") %>' Text="选择" CommandArgument='<%# Eval("RepnState") %>' OnCommand="LinkButton1_Command"  OnClientClick=" return confirm('是否审核')"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
