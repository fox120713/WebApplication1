<%@ Page Title="" Language="C#" MasterPageFile="~/管理员/site.Master" AutoEventWireup="true" CodeBehind="zhibantianjia.aspx.cs" Inherits="WebApplication1.管理员.zhibantianjia"  %>
    ...
    <div class="panel-body ">
        ...
        <tr>
            <td>
                ...
                员工编号:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></td>
        </tr>
        
        <tr>
            <td>员工姓名:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
